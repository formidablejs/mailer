...
const $3 = Symbol.for('#__init__'), $4 = Symbol.for('#__patch__'), $12 = Symbol.for('#__initor__'), $13 = Symbol.for('#__inited__'), $5 = Symbol.for('#__hooks__');
...
class Mail {
	[$4]($$ = {}){
		var $6;
		($6 = $$.toList) !== undefined && (this.toList = $6);
		($6 = $$.ccList) !== undefined && (this.ccList = $6);
		($6 = $$.bccList) !== undefined && (this.bccList = $6);
		($6 = $$.emailReplyTo) !== undefined && (this.emailReplyTo = $6);
		($6 = $$.emailFrom) !== undefined && (this.emailFrom = $6);
		($6 = $$.emailSubject) !== undefined && (this.emailSubject = $6);
		($6 = $$.emailAttachments) !== undefined && (this.emailAttachments = $6);
	...
	*/
	smtpTransport(mailer){
		...
		((($7 = transport.username),delete transport.username, $7));
		((($8 = transport.password),delete transport.password, $8));
		((($9 = transport.transport),delete transport.transport, $9));
	...
	*/
	sendmailTransport(mailer){
		...
		((($10 = transport.transport),delete transport.transport, $10));
	...
	*/
	async raw(content,text = null){
		...
		const mail = {
			from: (($11 = this.emailFrom) != null) ? ($11) : (("" + (settings.config.from.name) + " <" + (settings.config.from.address) + ">")),
			to: this.toList,
